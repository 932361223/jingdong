...
// axios.defaults.headers.post['Content-Type'] = 'application/json' //已经封装处理
...
export default {
  name: 'Login',
  components: { Toast },
  setup () { //setup告诉你代码一个流程
    const { toastMessage, show, showToast } = useToastEffect()
    const { username, password, handleLogin } = useLoginEffect(showToast)
    const { handleRegisterClick } = useRegisterEffect()
    return { handleRegisterClick, handleLogin, username, password, toastMessage, show, showToast }
  }
}
</script>
